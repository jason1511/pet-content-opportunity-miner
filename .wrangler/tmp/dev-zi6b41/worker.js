  ...
  async fetch(request, env2) {
    ...
    if (request.method === "GET" && url.pathname === "/api/autocomplete") {
      try {
        ...
        const autocompleteUrl = `https://suggestqueries.google.com/complete/search?client=firefox&q=${encodeURIComponent(keyword)}`;
...
// .wrangler/tmp/bundle-4RTigd/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-4RTigd/middleware-loader.entry.ts
